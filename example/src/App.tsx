...
import { Object3D, Vector3, TextureLoader, DataTexture } from 'three'
...
const SurfaceContainer = ({ scale, ticks, domains, marker }: any) => {
    ...
    return (
        <Suspense fallback={null}>
            ...
            <Surface map={map} depth={depth} scale={scale} marker={marker} />
        </Suspense>
    )
}
    ...
    return (
        <div className="canvas">
            ...
            <Canvas frameloop="demand" linear flat >
                ...
                <pointLight intensity={0.1} position={[-0.5, -0.5, 2]} />
                <Suspense fallback={null}>
                    <SurfaceContainer scale={scale} ticks={ticks} domains={domains} marker={marker}/>
                </Suspense>
